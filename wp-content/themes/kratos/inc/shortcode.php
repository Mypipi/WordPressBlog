...
function fa_get_wpsmiliestrans(){
    ...
    if(kratos_option('owo_out')) $owodir = 'https://cdn.jsdelivr.net/gh/Mypipi/WorldPress@'.KRATOS_VERSION; else $owodir = get_bloginfo('template_directory');
    foreach($wpsmilies as $alt => $src_path){
        $traimgna = substr($alt,1,-1);
        $output .= '<a class="add-smily" data-smilies="'.$alt.'"><img src="'.$owodir.'/cyp.xyz/wp-content/themes/kratos/static/images/smilies/'.$traimgna.'.png"></a>';
    }
    return $output;
}
